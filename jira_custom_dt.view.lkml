 view: jira_custom_dt {
  ...
  i.request_type_,
  CASE
        WHEN i.project IN (15152, 10700, 15161) THEN 'Tech'
        WHEN i.project IN (10500, 14106, 14133, 10800, 10811, 12700, 14052, 12800) THEN 'Core'
        WHEN i.project IN (13600) THEN 'Devops & DBA'
        WHEN i.project IN (14089) THEN 'Cards'
        WHEN i.project IN (11301) THEN 'Data Science'
  ...
  END AS Tribe,
  CASE
        WHEN i.project = 15152 THEN 'Mule'
        WHEN i.project = 10700 THEN 'MuleSoft'
        WHEN i.project = 15161 THEN 'Iraq_Integration'
        WHEN i.project = 10500 THEN 'Core Banking'
        WHEN i.project = 14106 THEN 'Core Upgrade'
        WHEN i.project = 14133 THEN 'Iraq Branches Opening'
        WHEN i.project = 10800 THEN 'Treasury'
        WHEN i.project = 10811 THEN 'ECC'
        WHEN i.project = 12700 THEN 'Core Support'
        WHEN i.project = 14052 THEN 'ERPHCM'
        WHEN i.project = 12800 THEN 'ERP System'
        WHEN i.project = 13600 THEN 'DevOPS'
        WHEN i.project = 14089 THEN 'card'
        WHEN i.project = 11301 THEN 'OBIEE'
        WHEN i.project = 15138 THEN 'Enterprise Operation'
        WHEN i.project = 11400 THEN 'Infrastructure'
        WHEN i.project = 14100 THEN 'Payment'
        WHEN i.project = 14101 THEN 'Business Lending'
        WHEN i.project = 14099 THEN 'CRMS'
        WHEN i.project = 14095 THEN 'Churn'
        WHEN i.project = 14098 THEN 'In-Person Onboarding'
        WHEN i.project = 14102 THEN 'Process Transformation'
        ...
        WHEN i.project = 14092 THEN 'Omnichannels'
